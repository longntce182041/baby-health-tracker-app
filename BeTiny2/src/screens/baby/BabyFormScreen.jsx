...
export default function BabyFormScreen({ route, navigation }) {
  ...
  const isProfileFormValid = (() => {
    ...
    const dobResult = parseDobFromParts(
      form.dobDay,
      form.dobMonth,
      form.dobYear,
    );
    ...
    <View style={styles.container}>
      ...
      >
        <View style={styles.headerRow}>
          ...
          <Text style={styles.headerTitle}>
            {isEdit ? "Chỉnh sửa hồ sơ" : "Thêm hồ sơ bé"}
          </Text>
          <View style={{ width: 40 }} />
        </View>
      </LinearGradient>
      ...
      >
        ...
        <View style={styles.fieldWrap}>
              ...
              <View style={styles.dobPartsRow}>
                <TextInput
                  style={[
                    styles.input,
                    styles.dobPartInput,
                    focusedDobField === "day" && styles.dobPartInputFocused,
                  ]}
                  value={form.dobDay}
                  onChangeText={(v) => {
                    setForm((f) => ({
                      ...f,
                      dobDay: v.replace(/\D/g, "").slice(0, 2),
                    }));
                  }}
                  placeholder="dd"
                  placeholderTextColor={colors.textMuted}
                  ...
                  onBlur={() => {
                    ...
                    const result = parseDobFromParts(
                      form.dobDay,
                      form.dobMonth,
                      form.dobYear,
                    );
                ...
                <TextInput
                  style={[
                    styles.input,
                    styles.dobPartInput,
                    focusedDobField === "month" && styles.dobPartInputFocused,
                  ]}
                  value={form.dobMonth}
                  onChangeText={(v) => {
                    setForm((f) => ({
                      ...f,
                      dobMonth: v.replace(/\D/g, "").slice(0, 2),
                    }));
                  }}
                  placeholder="mm"
                  placeholderTextColor={colors.textMuted}
                ...
                <TextInput
                  style={[
                    ...
                    styles.dobPartInput,
                    styles.dobYearInput,
                    focusedDobField === "year" && styles.dobPartInputFocused,
                  ]}
                  value={form.dobYear}
                  onChangeText={(v) => {
                    setForm((f) => ({
                      ...f,
                      dobYear: v.replace(/\D/g, "").slice(0, 4),
                    }));
                  }}
                  placeholder="yyyy"
                  placeholderTextColor={colors.textMuted}
          ...
          {!!errors.dobInput && (
            <Text style={styles.errorText}>{errors.dobInput}</Text>
          )}
        </View>
          ...
          >
                        ...
                        >
                          <Text
                            style={[
                              ...
                              active && styles.yearPickerItemTextActive,
                            ]}
                          >
                            {y}
                          </Text>
            ...
            <View style={styles.calendarNav}>
              <TouchableOpacity
                ...
                onPress={() => changeDobPickerMonth(-1)}
              >
              ...
              {getDobCalendarGrid().cells.map((day, i) => {
                ...
                const dateStr =
                  day != null
                    ...
                    : null;
                const activeIso = parseDobFromParts(
                  form.dobDay,
                  form.dobMonth,
                  form.dobYear,
                );
