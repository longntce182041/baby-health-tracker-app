...
export default function GrowthChartScreen({ navigation, route }) {
  ...
  const [measureDatePickerVisible, setMeasureDatePickerVisible] =
    useState(false);
  const [measureYearPickerVisible, setMeasureYearPickerVisible] =
    useState(false);
  ...
  const isMeasureFormValid = (() => {
    ...
    if (Number.isNaN(nw) || Number.isNaN(nh) || Number.isNaN(nHead))
      return false;
  ...
  const latestHead =
    (latestRecord?.head_size ?? latestRecord?.head_circumference) != null
      ? (latestRecord?.head_size ?? latestRecord?.head_circumference)
      : "—";
  ...
  const filteredRecords = (() => {
    ...
    return growthRecords.filter(
      (r) => !t || new Date(r.recorded_at).getTime() >= t,
    );
  })();
    ...
    .map((r) => {
      const v =
        metric === "weight"
          ...
          : metric === "height"
            ? r.height
            : (r.head_size ?? r.head_circumference);
        ...
        {!hasBabies ? (
          <View style={styles.emptyBlock}>
            ...
            <Text style={styles.emptyHint}>
              Thêm bé ở Trang chủ hoặc Danh sách bé để theo dõi biểu đồ thể
              trạng.
            </Text>
            <TouchableOpacity
          ...
          <>
            ...
            <View style={styles.chartContainer}>
              <View style={styles.chartTabs}>
                {METRICS.map((m) => (
                  <TouchableOpacity
                    ...
                    style={[
                      styles.chartTab,
                      metric === m.key && styles.chartTabActive,
                    ]}
                  ...
                  >
                    <Text
                      style={[
                        styles.chartTabText,
                        metric === m.key && styles.chartTabTextActive,
                      ]}
                      numberOfLines={1}
                    >
                      {m.label}
              ...
              <Modal
                visible={timeRangePickerVisible}
                transparent
                animationType="fade"
              >
                <Pressable
                  style={styles.pickerOverlay}
                  onPress={() => setTimeRangePickerVisible(false)}
                >
                  <View style={styles.pickerCard}>
                    ...
                    {TIME_RANGES.map((r) => (
                      <TouchableOpacity
                        ...
                        style={[
                          styles.pickerOption,
                          timeRange === r.key && styles.pickerOptionActive,
                        ]}
                        onPress={() => {
                          setTimeRange(r.key);
                  ...
                  metric === "weight"
                    ...
                    : metric === "height"
                      ...
                      : growthRecords
                          .filter(
                            (r) =>
                              (r.head_size ?? r.head_circumference) != null,
                          )
                          .map((r) => ({
                            value: r.head_size ?? r.head_circumference,
                            label: r.recorded_at
                              ? new Date(r.recorded_at).toLocaleDateString(
                                  "vi-VN",
                                )
              ...
              <View style={styles.legendRow}>
                ...
                <View style={styles.legendItem}>
                  <View
                    style={[styles.legendDot, { backgroundColor: "#ddd" }]}
                  />
            ...
            <View style={styles.insightBox}>
              ...
              <View style={styles.insightText}>
                ...
                <Text style={styles.insightContent}>
                  Cân nặng của {displayName} đang phát triển rất tốt, nằm trong
                  phạm vi tiêu chuẩn của WHO. Bố mẹ nên tiếp tục duy trì chế độ
                  ăn dặm hiện tại nhé!
                </Text>
              </View>
            </View>
            ...
            <View style={styles.chartInfoCard}>
              <View style={styles.chartInfoHeader}>
                ...
                <Text style={styles.chartInfoTitle}>
                  Hiểu về biểu đồ tăng trưởng
                </Text>
              </View>
              <Text style={styles.chartInfoParagraph}>
                Biểu đồ tăng trưởng so sánh các số đo của bé với tiêu chuẩn của
                WHO dựa trên hàng nghìn trẻ em khỏe mạnh trên toàn thế giới.
              </Text>
              <Text style={styles.chartInfoTerm}>• Đường trung bình:</Text>
              <Text style={styles.chartInfoDesc}>
                Giữa (phần trăm thứ 50) của phạm vi bình thường.
              </Text>
              <Text style={styles.chartInfoTerm}>• Khu vực được tô bóng:</Text>
              <Text style={styles.chartInfoDesc}>
                Mức tăng trưởng bình thường (từ 15 đến 85 phần trăm).
              </Text>
              <Text style={styles.chartInfoTerm}>• Đường của bé:</Text>
              <Text style={styles.chartInfoDesc}>
                Mô hình phát triển cá nhân theo thời gian.
              </Text>
              <Text style={styles.chartInfoNote}>
                Hãy nhớ: Mỗi em bé phát triển theo tốc độ riêng của mình. Các
                mẫu phát triển ổn định quan trọng hơn các phần trăm chính xác.
                Hãy tham khảo ý kiến bác sĩ nhi khoa nếu bạn có bất kỳ lo lắng
                nào.
              </Text>
            </View>
          </>
          ...
          >
            ...
            >
              ...
              <View style={styles.modalBody}>
                ...
                <TouchableOpacity
                  style={[
                    styles.modalDateTrigger,
                    focusedMeasureField === "date" && styles.modalInputFocused,
                  ]}
                  onPress={() => {
                    setFocusedMeasureField("date");
                    setMeasureDatePickerVisible(true);
                  }}
                  activeOpacity={0.8}
                >
                  <Text
                    style={[
                      ...
                      !measureForm.date && styles.modalInputPlaceholder,
                    ]}
                  >
                    {measureForm.date
                      ? formatMeasureDateDisplay(measureForm.date)
                      : "Chọn ngày (không chọn ngày tương lai)"}
                  </Text>
                  <Ionicons
                ...
                <Modal
                  visib2rle={measureDatePickerVisible}
                  transparent
                  animationType="fade"
                >
                  <Pressable
                    ...
                    >
                      ...
                      <View style={styles.calendarYearNav}>
                        <TouchableOpacity
                          ...
                          onPress={openMeasureYearPicker}
                          activeOpacity={0.8}
                        >
                          <Text style={styles.calendarYearTitle}>
                            {measurePickerMonth.split("-")[0]}
                          </Text>
                          <Ionicons
                            name="chevron-down"
                            size={18}
                                ...
                                return (
                                  <TouchableOpacity
                                    ...
                                    style={[
                                      ...
                                      active && styles.yearPickerItemActive,
                                    ]}
                      ...
                      <View style={styles.calendarNav}>
                        <TouchableOpacity
                          ...
                          onPress={() => changeMeasurePickerMonth(-1)}
                        >
                          <Ionicons
                            name="chevron-back"
                            size={22}
                        ...
                        <Text style={styles.calendarNavTitle}>
                          {
                            MONTH_NAMES[
                              parseInt(measurePickerMonth.split("-")[1], 10) - 1
                            ]
                          }
                        </Text>
                        <TouchableOpacity
                ...
                <TextInput
                  style={[
                    styles.modalInput,
                    focusedMeasureField === "weight" &&
                      styles.modalInputFocused,
                  ]}
                  ...
                  onBlur={() => {
                    setFocusedMeasureField(null);
                    const err = validateMeasureField(
                      "weight",
                      measureForm.weight,
                    );
                ...
                />
                {!!measureFieldErrors.weight && (
                  <Text style={styles.measureErrorText}>
                    {measureFieldErrors.weight}
                  </Text>
                )}
                ...
                <TextInput
                  style={[
                    styles.modalInput,
                    focusedMeasureField === "head" && styles.modalInputFocused,
                  ]}
                  ...
                  onBlur={() => {
                    ...
                    const err = validateMeasureField(
                      "head",
                      measureForm.head_circumference,
                    );
                    setMeasureFieldErrors((e) => ({ ...e, head: err }));
                  }}
                />
                {!!measureFieldErrors.head && (
                  <Text style={styles.measureErrorText}>
                    {measureFieldErrors.head}
                  </Text>
                )}
              ...
              <TouchableOpacity
                style={[
                  styles.modalSubmit,
                  (!isMeasureFormValid || measureSaving) &&
              ...
              >
                <Text
                  style={[
                    ...
                    (!isMeasureFormValid || measureSaving) &&
                      styles.modalSubmitTextDisabled,
                  ]}
                >
