...
function isValidVietnamPhone(phone) {
  ...
  // Kiểm tra số điện thoại Việt Nam: 10 số, bắt đầu 03, 05, 07, 08, 09
...
export default function RegisterScreen({ navigation }) {
  ...
  const showErrorEmail = touched.email && !form.email?.trim();
  const showErrorPhone = touched.phone && !isValidVietnamPhone(form.phone);
  ...
  const handleSubmit = async () => {
    ...
    if (!isValidVietnamPhone(form.phone)) {
      Alert.alert(
        "Lỗi",
        "Số điện thoại không đúng định dạng (10 số, bắt đầu 03/05/07/08/09)",
      );
      return;
    }
      ...
      <View style={styles.formCard}>
        <View style={styles.fieldWrap}>
          ...
          <View
            style={[
              styles.inputBox,
              focused.fullName && styles.inputBoxFocused,
              showErrorFullName && styles.inputBoxError,
            ]}
          >
            <TextInput
        ...
        <View style={styles.fieldWrap}>
          ...
          <View
            style={[
              ...
              showErrorEmail && styles.inputBoxError,
            ]}
          >
            <TextInput
              style={styles.inputInnerSmall}
        ...
        <View style={styles.fieldWrap}>
          ...
          <View
            style={[
              ...
              showErrorPhone && styles.inputBoxError,
            ]}
          >
            <TextInput
              style={styles.inputInnerSmall}
              ...
              value={form.phone}
              onChangeText={(v) =>
                setForm((f) => ({ ...f, phone: v.replace(/[^0-9]/g, "") }))
              }
          ...
          {showErrorPhone && (
            <Text style={styles.errorText}>
              {!form.phone?.trim()
                ...
                : "Số điện thoại phải 10 số, bắt đầu 03/05/07/08/09"}
            </Text>
          )}
        </View>
        ...
        <View style={styles.fieldWrap}>
          ...
          <View
            style={[
              ...
              showErrorPassword && styles.inputBoxError,
            ]}
          >
        ...
        <View style={styles.fieldWrap}>
          ...
          <View
            style={[
              ...
              showErrorConfirm && styles.inputBoxError,
            ]}
          >
            <View style={styles.inputRow}>
              <TextInput
