...
function BabyAvatar({ baby, size = "md" }) {
  ...
  return (
    <AvatarCircle
      initial={getBabyDisplayInitial(baby?.full_name)}
...
const BANNER_SLIDES = [
  {
    key: "health",
    title: "Đặt lịch",
    subtitle: "Lên lịch hẹn định kỳ",
    onPress: "schedule",
    icon: "calendar-check",
    colors: ["#F4ABB4", "#ff004056"],
    blobTop: "rgba(255, 67, 107, 0.27)",
    blobBottom: "rgba(254, 211, 221, 0.5)",
    btnColor: "#C94A5A",
    shadowColor: "#F4ABB4",
    textDark: false,
  },
  {
    key: "vaccine",
    title: "Tiêm chủng",
    subtitle: "Xem lịch tiêm cho bé",
    onPress: "vaccine",
    icon: "needle",
    colors: ["#FED3DD", "#FFFFFF"],
    blobTop: "rgba(254, 211, 221, 0.45)",
    blobBottom: "rgba(255,255,255,0.5)",
    btnColor: "#E85A6B",
    shadowColor: "#FED3DD",
    textDark: true,
  },
  {
    ...
    onPress: "consult",
    icon: "stethoscope",
    colors: ["#A8D5BA", "#E5F2E9"],
    blobTop: "rgba(168, 213, 186, 0.5)",
    blobBottom: "rgba(229, 242, 233, 0.6)",
    btnColor: "#5A9B72",
    shadowColor: "#A8D5BA",
    textDark: true,
  },
...
export default function HomeScreen({ navigation }) {
  ...
  const openConsultationTab = () =>
    navigation.getParent()?.navigate("ConsultationTab");
    ...
    <View style={styles.safe}>
      ...
      <View
        style={[
          ...
          { paddingTop: insets.top + 8, paddingBottom: 18 },
        ]}
      >
                ...
                <Pressable
                  ...
                  onPress={() =>
                    navigation.navigate("BabyDetail", {
                      id: selectedBaby.baby_id || selectedBaby.id,
                      baby: selectedBaby,
                    })
                  }
                >
                  ...
                  <View style={styles.profileText}>
                    <Text style={styles.profileName} numberOfLines={1}>
                      {getBabyDisplayName(selectedBaby.full_name)}
                    </Text>
                    <Text
                      style={styles.profileAge}
                      numberOfLines={1}
                      ellipsizeMode="tail"
                    >
                      {getAgeString(selectedBaby.date_of_birth)}
                    </Text>
                  </View>
                </Pressable>
                <TouchableOpacity
      ...
      >
        ...
        <View style={styles.bannerCarouselWrap}>
          ...
          >
            {BANNER_SLIDES.map((slide) => (
              <View
                key={slide.key}
                style={[styles.bannerSlideWrapper, { width: bannerSlideWidth }]}
              >
                <TouchableOpacity
                  style={[
                    styles.bannerCard,
                    { width: bannerCardWidth, shadowColor: slide.shadowColor },
                  ]}
                ...
                >
                  ...
                  >
                    <View
                      style={[
                        styles.bannerBlobTopRight,
                        { backgroundColor: slide.blobTop },
                      ]}
                    />
                    <View
                      style={[
                        styles.bannerBlobBottomLeft,
                        { backgroundColor: slide.blobBottom },
                      ]}
                    />
                    <View style={styles.bannerRectContent}>
                      <View style={styles.bannerTextBlock}>
                        <Text
                          style={[
                            styles.bannerTitle,
                            slide.textDark && styles.bannerTitleDark,
                          ]}
                          numberOfLines={1}
                        >
                          {slide.title}
                        ...
                        <Text
                          style={[
                            ...
                            slide.textDark && styles.bannerSubtitleDark,
                          ]}
                          numberOfLines={1}
                        >
                          {slide.subtitle}
                      ...
                      <View style={styles.bannerIconWrap}>
                        <MaterialCommunityIcons
                          ...
                          size={32}
                          color={
                            slide.textDark ? colors.textSecondary : colors.white
                          }
                        />
                      </View>
                    </View>
        ...
        <View style={styles.grid}>
          <TouchableOpacity
            ...
            onPress={() =>
              goVaccinationCatalog(selectedBaby?.baby_id || selectedBaby?.id)
            }
            activeOpacity={0.8}
          >
            <View
              style={[
                styles.gridIconWrap,
                { backgroundColor: "rgba(244,171,180,0.5)" },
              ]}
            >
              <MaterialCommunityIcons
                name="clock-outline"
            ...
            <Text style={[styles.gridLink, { color: colors.pinkAccent }]}>
              Xem thêm →
            </Text>
          </TouchableOpacity>
          ...
          >
            <View
              style={[
                styles.gridIconWrap,
                { backgroundColor: "rgba(156,123,168,0.4)" },
              ]}
            >
              <MaterialCommunityIcons
                name="heart-pulse"
            ...
            <Text style={[styles.gridLink, { color: "#9C7BA8" }]}>
              Xem thêm →
            </Text>
          </TouchableOpacity>
          ...
          <TouchableOpacity
            ...
            onPress={() =>
              goVaccinationSchedule(selectedBaby?.baby_id || selectedBaby?.id)
            }
            activeOpacity={0.8}
          >
            <View
            ...
            <Text style={[styles.gridLink, { color: "#C4956A" }]}>
              Xem thêm →
            </Text>
          </TouchableOpacity>
        </View>
            ...
            >
              ...
              >
                {babies.map((b, idx) => {
                  ...
                  const isSelected =
                    sid != null && bid != null && String(sid) === String(bid);
                  return (
                    <TouchableOpacity
                      key={b.baby_id || b.id}
                      style={[
                    ...
                    >
                      ...
                      <View style={styles.dropdownItemText}>
                        ...
                        <Text style={styles.dropdownItemAge}>
                          {getAgeString(b.date_of_birth)}
                        </Text>
                      </View>
                      <View
                        style={[
                          styles.dropdownItemBadge,
                          isSelected && styles.dropdownItemBadgeSelected,
                        ]}
                      >
                        <Ionicons
                          ...
                          size={16}
                          color={
                            isSelected ? colors.pinkAccent : colors.textMuted
                          }
                        />
                      </View>
                    </TouchableOpacity>
