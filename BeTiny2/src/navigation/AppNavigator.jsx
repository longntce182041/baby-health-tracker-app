...
function MainTabs() {
  return (
    ...
    >
      <Tab.Screen name="ConsultationTab" component={DoctorListScreen} options={{ title: 'Bác sĩ tư vấn' }} />
      <Tab.Screen name="HealthTab" component={GrowthChartScreen} options={{ title: 'Biểu đồ thể trạng' }} />
      <Tab.Screen name="HomeTab" component={HomeScreen} options={{ title: 'Trang chủ' }} />
      <Tab.Screen name="VaccinationTab" component={VaccinationTabScreen} options={{ title: 'Tiêm chủng' }} />
      <Tab.Screen name="HealthLogTab" component={HealthLogScreen} options={{ title: 'Nhật ký sức khỏe' }} />
    </Tab.Navigator>
  );
}
  ...
  return (
    <NavigationContainer ref={navigationRef}>
      ...
      >
        ...
        <Stack.Screen name="BabyDetail" component={BabyDetailScreen} options={{ headerShown: false }} />
        <Stack.Screen name="BabyForm" component={BabyFormScreen} options={{ headerShown: false }} />
        <Stack.Screen name="BabyList" component={BabyListScreen} options={{ headerShown: false }} />
        <Stack.Screen name="HealthLog" component={HealthLogScreen} options={{ title: 'Nhật ký sức khỏe' }} />
        <Stack.Screen name="HealthLogAdd" component={HealthLogAddScreen} options={{ headerShown: false }} />
        <Stack.Screen name="GrowthChart" component={GrowthChartScreen} options={{ title: 'Biểu đồ thể trạng', headerShown: false }} />
        <Stack.Screen name="VaccinationGuide" component={VaccinationGuideScreen} options={{ headerShown: false }} />
        <Stack.Screen name="VaccinationSchedule" component={VaccinationScheduleScreen} options={{ headerShown: false }} />
        <Stack.Screen name="VaccinationCatalog" component={VaccinationCatalogScreen} options={{ headerShown: false }} />
        <Stack.Screen name="VaccinationCatalogDetail" component={VaccinationCatalogDetailScreen} options={{ headerShown: false }} />
        <Stack.Screen name="VaccinationBooking" component={VaccinationBookingScreen} options={{ headerShown: false }} />
        <Stack.Screen name="VaccinationBookConfirm" component={VaccinationBookConfirmScreen} options={{ headerShown: false }} />
        <Stack.Screen name="VaccinationNotes" component={VaccinationNotesScreen} options={{ headerShown: false }} />
        ...
        <Stack.Screen name="Notification" component={NotificationScreen} options={{ title: 'Thông báo', headerShown: false }} />
        <Stack.Screen name="ProfileEdit" component={ProfileEditScreen} options={{ headerShown: false }} />
        <Stack.Screen name="PackageList" component={PackageListScreen} options={{ title: 'Gói dịch vụ' }} />
        <Stack.Screen name="Transaction" component={TransactionScreen} options={{ title: 'Lịch sử giao dịch' }} />
        <Stack.Screen name="TopUpPoints" component={TopUpPointsScreen} options={{ headerShown: false }} />
      </Stack.Navigator>
    </NavigationContainer>
  );
}
